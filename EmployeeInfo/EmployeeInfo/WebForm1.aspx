...
<body>
    <form id="form1" runat="server" >
        ...
        <div class="nuevoEstilo3"> 
            <asp:Label ID="Label2" runat="server" Text="Nombre" Font-Names="Alef"></asp:Label>  &nbsp; &nbsp; 
            <asp:TextBox ID="TextBox2" runat="server" Height="24px" Width="230px"></asp:TextBox> &nbsp; &nbsp;&nbsp;
            <asp:Label ID="Label3" runat="server" Text="Apellido" Font-Names="Alef"></asp:Label> &nbsp; &nbsp;&nbsp;
            <asp:TextBox ID="Apellido" runat="server" Height="24px" Width="230px"></asp:TextBox>
            <br />  
            <br />  
            <asp:Label ID="Label4" runat="server" Text="Código" Font-Names="Alef"></asp:Label> &nbsp; &nbsp; &nbsp;
            <asp:TextBox ID="TextBox1" runat="server" Height="24px" Width="230px"></asp:TextBox> &nbsp; &nbsp; &nbsp; 
            <asp:Label ID="Label6" runat="server" Text="Rol" Font-Names="Alef"></asp:Label> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="Rol" runat="server" AutoPostBack="True" Width="230px"></asp:DropDownList> &nbsp; &nbsp; &nbsp;
            <br />  
            <br />
            <asp:Label ID="Label5" runat="server" Text="Posición" Font-Names="Alef"></asp:Label> 
            <br />  
